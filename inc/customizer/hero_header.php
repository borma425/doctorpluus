...
$wp_customize->add_setting('basic-hero_header-callout-desc', array(
    'default' => '',
    'sanitize_callback' => array( $this, 'sanitize_custom_text' )
));
$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'basic-hero_header-callout-desc', array(
    'label' => 'description',
    'section' => 'basic-hero_header-callout-section',
    'settings' => 'basic-hero_header-callout-desc',
    'type' => 'textarea'
)));
...
$wp_customize->add_setting('basic-hero_header-callout-sub_desc', array(
    'default' => '',
    'sanitize_callback' => array( $this, 'sanitize_custom_text' )
));
$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'basic-hero_header-callout-sub_desc', array(
    'label' => 'sub description',
    'section' => 'basic-hero_header-callout-section',
    'settings' => 'basic-hero_header-callout-sub_desc',
    'type' => 'textarea'
)));
